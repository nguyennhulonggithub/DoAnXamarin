...
router.get("/user/:idUser", (req, res) => {
  let sql =
    "select user_idUser as idUser, idManga, Name, ImageAPI, DateAdded, Free,(select count(*) from chapter where manga_idManga = idManga) as chapter from subscribe join manga on subscribe.manga_idManga = manga.idManga where user_idUser = ?";
